...
| | 🇨🇳 </br> zh | 🇯🇵 </br> ja |
|---|---|---|
| 🇨🇳 (zh) </br> Chinese  |  [zh-zh](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-zh-zh.zip) </br> |  [zh-ja](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-zh-ja.zip) </br>
| 🇯🇵 (ja) </br> Japanese  |  [ja-zh](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-ja-zh.zip) </br> |  [ja-ja](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-ja-ja.zip) </br>
## IPA Dictionaries
...
| | 🇨🇳 </br> zh | 🇯🇵 </br> ja | Merged |
|---|---|---|---|
| 🇨🇳 </br> Chinese (zh) |  [zh-zh](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-zh-zh-ipa.zip) </br> |  [zh-ja](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-zh-ja-ipa.zip) </br> |  [zh merged](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-zh-ipa.zip) </br>
| 🇯🇵 </br> Japanese (ja) |  [ja-zh](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-ja-zh-ipa.zip) </br> |  [ja-ja](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-ja-ja-ipa.zip) </br> |  [ja merged](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-ja-ipa.zip) </br>
...
| | 🇨🇳 </br> zh | 🇯🇵 </br> ja |
|---|---|---|
| 🇨🇳 </br> Chinese (zh) |  |  [ja-zh](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-ja-zh-gloss.zip) </br>
| 🇯🇵 </br> Japanese (ja) |  [zh-ja](https://github.com/yomidevs/kaikki-to-yomitan/releases/latest/download/kty-zh-ja-gloss.zip) </br> | 
